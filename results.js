...
function displayResults(searchTerm) {
    ...
    const data = [
        ...
        { title: "labour", url: "laws.html" },
        { title: "labour law", url: "laws.html" },
        { title: "Property law", url: "laws.html" },
        { title: "property", url: "laws.html" },
        { title: "Muslim family", url: "laws.html" },
        { title: "Muslim", url: "laws.html" },
        { title: "Criminal Law", url: "laws.html" },
        { title: "Criminal", url: "laws.html" },
        { title: "Queries", url: "legalqueries.html" },
        { title: "labour", url: "laws.html" },
